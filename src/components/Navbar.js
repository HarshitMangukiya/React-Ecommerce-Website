...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand mx-5" to="/"><img src="./image/Asset 1.svg" width="auto" height="55px" /></Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">  
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <Link className="nav-link" to="/product"><strong>Product</strong></Link>
        </li>
        <li className="nav-item">
